...
english.DependencyHint=Missing tools are not installed silently. Guardian can install verified Hamlib after confirmation. Use the official VARA download source for VARA FM/HF.
...
czech.DependencyHint=Chybějící nástroje se neinstalují bez souhlasu. Guardian umí po potvrzení nainstalovat ověřený Hamlib. Pro VARA FM/HF použijte oficiální zdroj VARA.
